...
graduates.forEach((grad) => {
  if(grad.university.startsWith("Uni")){
...
zooAnimals.forEach((animal) => {
  displayNames.push(`Name: ${animal.name}, Scientific: ${animal.scientific_name}`);
})
...
*/
const population = (acc, curr) => {
  // console.log("IN POPULATION");
  // console.log(acc, curr.population);
